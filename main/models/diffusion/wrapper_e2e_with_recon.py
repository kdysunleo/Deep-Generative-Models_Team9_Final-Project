...
class DDPMWrapperE2ERecon(pl.LightningModule):
    def __init__(
        self,
        online_network,
        target_network,
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.conditional:
            ...
            # reconstruct
            recons_loss = self.mse_loss(cond, x)
        ...
        loss += 0.3 * (recons_loss + self.alpha * kl_loss)
        # loss += 0.1 * (recons_loss + self.alpha * kl_loss)
