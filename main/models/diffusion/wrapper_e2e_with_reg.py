...
class DDPMWrapperE2EReg(pl.LightningModule):
    def __init__(
        self,
        online_network,
        target_network,
    ...
    def training_step(self, batch, batch_idx):
        ...
        l2_reg_loss = 0.0
        for p1, p2 in zip(self.vae.parameters(), self.origin_vae.parameters()):
            l2_reg_loss += torch.sum((p1 - p2) ** 2)

        loss += self.alpha * l2_reg_loss
