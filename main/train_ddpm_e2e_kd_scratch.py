...
from models.diffusion import DDPM, DDPMv2, DDPMWrapperE2EKD_Scratch, SuperResModel, UNetModel
...
def train(config):
    ...
    origin_vae = VAE.load_from_checkpoint(
    ...
    ddpm_wrapper = DDPMWrapperE2EKD_Scratch(
        online_ddpm,
        target_ddpm,
        vae,
        origin_vae,
