python main/extract_latents_fdp.py extract --device gpu:2 \
                                --dataset-name cifar10 \
                                --image-size 32 \
                                --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar2_e2e_fbp_scratch_latents/ \
                                '/nlp_data/kdy/genai/DiffuseVAE/main/results/vae_fbp_cifar2_alpha=1.0_epochs=500/checkpoints/vae-cifar2_alpha=1.0-epoch=499-train_loss=0.0000.ckpt' \
                                /nlp_data/kdy/genai/DiffuseVAE/main/datasets/img_cifar10

python main/expde.py fit-gmm /nlp_data/kdy/genai/DiffuseVAE/cifar2_kd_scratch_latents/latents_cifar10.npy --save-path '/nlp_data/kdy/genai/DiffuseVAE/cifar2_kd_scratch_latents/gmm_z/' --n-components 50
...
python main/eval/ddpm/sample_cond_fbp.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_fbp_zcond_cifar2/checkpoints/ddpmv2-cifar10-epoch=499-loss=0.0255.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_fbp_zcond_cifar2_sample_cond/\' \
                        ...
                        dataset.vae.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/vae_fbp_cifar2_alpha=1.0_epochs=500/checkpoints/vae-cifar2_alpha=1.0-epoch=499-train_loss=0.0000.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/nlp_data/kdy/genai/DiffuseVAE/cifar2_fbp_latents/gmm_z/gmm_50.joblib\'
