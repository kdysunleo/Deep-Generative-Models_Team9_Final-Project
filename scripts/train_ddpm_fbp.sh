...
python main/train_ddpm_with_fbp.py +dataset=cifar10/train \
                     ...
                     dataset.ddpm.training.vae_chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/vae_fbp_cifar10_alpha=1.0_epochs=500/checkpoints/vae-cifar10_alpha=1.0-epoch=499-train_loss=0.0000.ckpt\' \
                     dataset.ddpm.training.device=\'gpu:1\' \
                     dataset.ddpm.training.results_dir=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_fbp_cifar10\' \
...
#                      dataset.ddpm.training.device=\'gpu:1\' \
#                      dataset.ddpm.training.results_dir=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_fbp_zcond_cifar2\' \
#                      dataset.ddpm.training.workers=8 \
#                      dataset.ddpm.training.chkpt_prefix=\'cifar10\'
