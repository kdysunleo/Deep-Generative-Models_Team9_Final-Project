...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.device=\'gpu:0\' \
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3/checkpoints/ddpmv2-cifar10_rework_form1_28thJuly_sota_nheads=8_dropout=0.3-epoch=499-loss=0.0405.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=64 \
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_cifar2_sample_cond/\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=2500 \
...
# fidelity --gpu 1 --fid --isc --input1 /nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_cifar2_sample_cond/1000/images --input2 cifar10-train
