...
python main/train_ddpm_e2e_kd.py +dataset=cifar10/train \
                     ...
                     dataset.ddpm.training.results_dir=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_kd_scratch_cifar2/\' \
                     dataset.ddpm.training.workers=8 \
                     dataset.ddpm.training.chkpt_prefix=\'cifar2_e2e_kd_scratch\'
