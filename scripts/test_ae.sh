...
python main/test_fbp.py sample --device gpu:1 \
                            --image-size 32 \
                            --seed 0 \
                            --num-samples 2000 \
                            --save-path /nlp_data/kdy/genai/DiffuseVAE/image_sample/vae_fbp2_test \
                            --write-mode image \
                            512 \
                            /nlp_data/kdy/genai/DiffuseVAE/main/results/vae_fbp_gelu_cifar2_alpha=1.0_epochs=500/checkpoints/vae-cifar10_alpha=1.0-epoch=499-train_loss=0.0000.ckpt \
