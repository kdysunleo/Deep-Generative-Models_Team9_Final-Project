...
#                         dataset.ddpm.evaluation.device=\'gpu:0\' \
#                         dataset.ddpm.evaluation.save_mode='image' \
#                         dataset.ddpm.evaluation.chkpt_path=\'/home/kdy/Desktop/DiffuseVAE/main/results/ddpm_vae_e2e.ckpt\' \
#                         dataset.ddpm.evaluation.type='uncond' \
...
#                         dataset.ddpm.evaluation.save_path=\'/home/kdy/Desktop/DiffuseVAE/image_sample/ddpm_cifar2_sample_uncond/\' \
#                         dataset.ddpm.evaluation.n_samples=2500 \
...
python main/extract_latents.py extract --device gpu:0 \
                                ...
                                --image-size 32 \
                                --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar2_scratch_latents/ \
                                '/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_scratch_cifar2/vae-epoch=499.ckpt' \
                                /nlp_data/kdy/genai/DiffuseVAE/main/datasets/img_cifar10


python main/expde.py fit-gmm /nlp_data/kdy/genai/DiffuseVAE/cifar2_scratch_latents/latents_cifar10.npy --save-path '/nlp_data/kdy/genai/DiffuseVAE/cifar2_scratch_latents/gmm_z/' --n-components 50
...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.save_mode='image' \
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_scratch_cifar2/checkpoints/ddpmv2-cifar10-epoch=499-loss=0.0347.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.temp=1.0 \
                        dataset.ddpm.evaluation.batch_size=64 \
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_e2e_scratch_cifar2_sample_cond/\' \
                        dataset.ddpm.evaluation.z_cond=False \
                        dataset.ddpm.evaluation.n_samples=2500 \
                        dataset.ddpm.evaluation.n_steps=1000 \
                        dataset.ddpm.evaluation.save_vae=True \
                        dataset.ddpm.evaluation.workers=4 \
                        dataset.vae.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_scratch_cifar2/vae-epoch=499.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/nlp_data/kdy/genai/DiffuseVAE/cifar2_scratch_latents/gmm_z/gmm_50.joblib\'

fidelity --gpu 1 --fid --isc --input1 /nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_e2e_scratch_cifar2_sample_cond/1000/images --input2 cifar10-train
