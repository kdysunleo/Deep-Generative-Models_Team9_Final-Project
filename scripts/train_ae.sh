...
python main/train_ae.py +dataset=cifar10/train \
                     ...
                     dataset.vae.training.results_dir=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/vae_cifar2_alpha=1.0_epochs=500/\' \
                     dataset.vae.training.workers=8 \
                     dataset.vae.training.chkpt_prefix=\'cifar2_alpha=1.0\' \
                     dataset.vae.training.alpha=1.0