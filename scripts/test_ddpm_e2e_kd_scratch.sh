python main/extract_latents.py extract --device gpu:3 \
                                ...
                                --image-size 32 \
                                --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar2_kd_scratch_latents/ \
                                '/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_kd_scratch_cifar2/vae-epoch=499.ckpt' \
...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_kd_scratch_cifar2/ddpmv2-cifar2_e2e_kd-epoch=499.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_e2e_kd_scratch_cifar2_sample_cond/\' \
                        ...
                        dataset.vae.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_kd_scratch_cifar2/vae-epoch=499.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/nlp_data/kdy/genai/DiffuseVAE/cifar2_kd_scratch_latents/gmm_z/gmm_50.joblib\'
