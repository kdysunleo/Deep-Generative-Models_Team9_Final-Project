...
#                                 --image-size 32 \
#                                 --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar2_fbp_scratch_latents/ \
...
python main/eval/ddpm/sample_cond_fbp.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_fbp_zcond_cifar10/checkpoints/ddpmv2-cifar10-epoch=499-loss=0.0411.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_fbp_zcond_cifar10/\' \
