python main/extract_latents.py extract --device gpu:0 \
                                ...
                                --image-size 32 \
                                --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar2_recon_latents/ \
                                '/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_recon_cifar2/vae-epoch=499.ckpt' \
                                /nlp_data/kdy/genai/DiffuseVAE/main/datasets/img_cifar10

python main/expde.py fit-gmm /nlp_data/kdy/genai/DiffuseVAE/cifar2_recon_latents/latents_cifar10.npy --save-path '/nlp_data/kdy/genai/DiffuseVAE/cifar2_recon_latents/gmm_z/' --n-components 50
...
python main/eval/ddpm/sample_cond.py +dataset=cifar10/test \
                        ...
                        dataset.ddpm.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_recon_cifar2/ddpmv2-cifar2_recon-epoch=499-loss=11688.7275.ckpt\' \
                        ...
                        dataset.ddpm.evaluation.save_path=\'/nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_e2e_recon_cifar2_sample_cond/\' \
                        ...
                        dataset.vae.evaluation.chkpt_path=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_recon_cifar2/vae-epoch=499.ckpt\' \
                        dataset.vae.evaluation.expde_model_path=\'/nlp_data/kdy/genai/DiffuseVAE/cifar2_recon_latents/gmm_z/gmm_50.joblib\'

fidelity --gpu 2 --fid --isc --input1 /nlp_data/kdy/genai/DiffuseVAE/image_sample/ddpm_e2e_recon_cifar2_sample_cond/1000/images --input2 cifar10-train
