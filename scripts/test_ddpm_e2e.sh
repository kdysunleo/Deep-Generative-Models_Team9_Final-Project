python main/extract_latents.py extract --device gpu:3 \
                                ...
                                --image-size 32 \
                                --save-path /nlp_data/kdy/genai/DiffuseVAE/cifar10_e2e_latents/ \
                                '/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_cifar10/vae-epoch=499.ckpt' \
                                /nlp_data/kdy/genai/DiffuseVAE/main/datasets/img_cifar10

python main/expde.py fit-gmm /nlp_data/kdy/genai/DiffuseVAE/cifar10_e2e_latents/latents_cifar10.npy --save-path '/nlp_data/kdy/genai/DiffuseVAE/cifar10_e2e_latents/gmm_z/' --n-components 50
