# # CIFAR-10 (Form-1)
python main/train_ddpm_e2e_scratch.py +dataset=cifar10/train \
                     ...
                     dataset.ddpm.training.results_dir=\'/nlp_data/kdy/genai/DiffuseVAE/main/results/diffusevae_e2e_scratch_cifar2/\' \
